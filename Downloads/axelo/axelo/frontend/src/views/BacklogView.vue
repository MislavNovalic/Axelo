...
.status-completed { background: rgba(92,79,255,0.12); color: var(--accent2); }
...
.action-btn {
  ...
  background: rgba(92,79,255,0.15); color: var(--accent2); font-weight: 500;
  transition: background 0.15s;
}
.action-btn:hover { background: rgba(92,79,255,0.25); }
