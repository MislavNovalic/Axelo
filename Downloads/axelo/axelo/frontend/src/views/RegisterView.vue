<template>
  <div class="auth-screen">
    <div class="auth-left">
      ...
      <div class="auth-hero">
        <h2>Start managing<br /><span>smarter today.</span></h2>
        <p>Create your free account and get your first project running in under two minutes.</p>
    ...
    <div class="auth-right">
      <div class="auth-card">
        ...
        <p class="subtitle">Start managing your projects for free</p>
        <div v-if="error" class="error-msg">{{ error }}</div>
        <div class="form-group">
          <label class="fd-label">Full name</label>
          <input v-model="form.full_name" type="text" class="fd-input" placeholder="Ada Lovelace" />
        </div>
        <div class="form-group">
          <label class="fd-label">Email address</label>
          <input v-model="form.email" type="email" class="fd-input" placeholder="you@company.com" />
        </div>
        <div class="form-group">
          <label class="fd-label">Password</label>
          <input v-model="form.password" type="password" class="fd-input" placeholder="Min. 8 characters" @keyup.enter="submit" />
        </div>
