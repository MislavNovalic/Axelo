...
<style scoped>
.ai-summary-panel {
  border: 1px solid rgba(187, 92, 247, 0.25);
  border-radius: 12px;
  background: linear-gradient(135deg, rgba(187,92,247,0.04) 0%, rgba(92,79,255,0.04) 100%);
...
.btn-summarise {
  padding: 6px 14px;
  background: rgba(187, 92, 247, 0.12);
  border: 1px solid rgba(187, 92, 247, 0.3);
  border-radius: 8px;
  color: #bb5cf7;
  font-size: 0.8rem;
  font-weight: 700;
...
.btn-summarise:hover:not(:disabled) {
  background: rgba(187, 92, 247, 0.2);
  border-color: rgba(187, 92, 247, 0.5);
}
...
.summary-body {
  margin-top: 1rem;
  border-top: 1px solid rgba(187,92,247,0.15);
...
.model-badge, .tokens-badge {
  ...
  background: rgba(187,92,247,0.08);
  color: var(--text3);
  border: 1px solid rgba(187,92,247,0.15);
}
.btn-ghost-xs {
  margin-left: auto;
  background: none;
