...
.mark-all-btn:hover { background: rgba(92,79,255,0.12); }
...
.filter-tabs button.active { background: rgba(92,79,255,0.15); color: var(--accent2); }
...
.notif-item.unread { background: rgba(92,79,255,0.07); }
.notif-item.unread:hover { background: rgba(92,79,255,0.12); }
...
.type-assigned         { background: rgba(92,79,255,0.15); }
...
.type-role_changed     { background: rgba(187,92,247,0.15); }
.type-sprint_started   { background: rgba(92,79,255,0.15); }
