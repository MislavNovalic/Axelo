...
.palette-item.selected, .palette-item:hover { background: rgba(92,79,255,0.12); }
.item-icon.project-icon {
  width: 24px; height: 24px; border-radius: 5px;
  background: rgba(92,79,255,0.15); color: var(--accent2);
...
.recent-chip {
  background: rgba(92,79,255,0.1); color: var(--accent2);
  font-family: var(--font-mono); font-size: 0.68rem;
  padding: 2px 8px; border-radius: 4px; cursor: pointer;
  transition: background 0.1s;
}
.recent-chip:hover { background: rgba(92,79,255,0.2); }
</style>
