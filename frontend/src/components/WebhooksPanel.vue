...
.event-chip { font-size: 0.72rem; background: rgba(92,79,255,0.1); color: var(--accent2); border: 1px solid rgba(92,79,255,0.2); border-radius: 4px; padding: 2px 7px; font-family: var(--font-mono); }
