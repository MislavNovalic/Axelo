...
async function renderQR(uri) {
  ...
  try {
    ...
    QRCode.toCanvas(qrCanvas.value, uri, { width: 200, margin: 2, color: { dark: '#5c4fff', light: '#1a1a2e' } })
  } catch {
...
.qr-box { background: #1a1a2e; border-radius: 10px; padding: 12px; display: inline-block; margin-bottom: 0.75rem; }
...
.code-input:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(92,79,255,0.15); }
...
.tfa-active-note { background: rgba(92,79,255,0.08); border: 1px solid rgba(92,79,255,0.2); border-radius: 10px; padding: 10px 14px; font-size: 0.85rem; color: var(--text2); margin-bottom: 1rem; }
