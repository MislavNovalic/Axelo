...
.issue-bar.epic { border-left-color: #bb5cf7; }
...
.bar-status.in_progress { background: rgba(92,79,255,0.12); color: var(--accent2); }
...
.epic-lane-header:hover { background: rgba(92,79,255,0.06); }
