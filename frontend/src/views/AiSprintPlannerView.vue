...
.ai-spark { color: #bb5cf7; animation: sparkle 2s ease-in-out infinite; }
...
.config-input:focus { border-color: #bb5cf7; box-shadow: 0 0 0 3px rgba(187,92,247,0.12); }
.btn-plan {
  padding: 10px 22px; background: linear-gradient(135deg, #bb5cf7, #5c4fff);
  ...
  box-shadow: 0 4px 16px rgba(187,92,247,0.3); transition: opacity 0.15s, transform 0.15s;
}
.btn-plan:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 6px 24px rgba(187,92,247,0.4); }
...
.metric-card.accent { background: rgba(187,92,247,0.08); border-color: rgba(187,92,247,0.25); }
...
.metric-card.accent .metric-value { color: #bb5cf7; }
.metric-label { font-size: 0.72rem; color: var(--text3); margin-top: 3px; font-family: var(--font-mono); }
.reasoning-box { background: rgba(187,92,247,0.05); border: 1px solid rgba(187,92,247,0.2); border-radius: 12px; padding: 1rem 1.25rem; }
.reasoning-label { font-size: 0.72rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: #bb5cf7; margin-bottom: 0.5rem; }
...
.btn-create-sprint { padding: 7px 14px; background: #bb5cf7; color: #fff; border: none; border-radius: 8px; font-size: 0.8rem; font-weight: 700; cursor: pointer; transition: opacity 0.15s; }
...
.pts-badge { font-family: var(--font-mono); font-size: 0.72rem; background: rgba(92,79,255,0.1); color: var(--accent2); border-radius: 4px; padding: 2px 6px; flex-shrink: 0; }
.pts-badge.empty { background: var(--bg3); color: var(--text3); }
.empty-state { text-align: center; padding: 3rem 2rem; color: var(--text3); }
.empty-icon { font-size: 2.5rem; color: #bb5cf7; margin-bottom: 1rem; opacity: 0.5; }
