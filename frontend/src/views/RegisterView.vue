    ...
    <div class="auth-left">
      ...
      <div class="auth-hero animate-fade-up">
        ...
        <div class="feature-pills">
          <div class="pill" style="--delay: 0.5s"><span class="dot" style="background:#5c4fff"></span> Free forever</div>
...
@keyframes logoPulse { 0%, 100% { box-shadow: 0 0 16px var(--accent-glow); } 50% { box-shadow: 0 0 32px var(--accent-glow), 0 0 8px rgba(92,79,255,0.4); } }
...
.btn-login-link {
  ...
  background: linear-gradient(135deg, #5c4fff, #bb5cf7);
