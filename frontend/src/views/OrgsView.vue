...
const COLORS = ['#5c4fff','#bb5cf7','#00d97e','#ff8c42','#0095ff','#ffd166']
...
.plan-badge.pro { background: rgba(92,79,255,0.12); color: var(--accent2); }
.plan-badge.enterprise { background: rgba(187,92,247,0.12); color: #bb5cf7; }
...
.tab-btn.active { background: rgba(92,79,255,0.1); color: var(--accent2); font-weight: 700; }
...
.role-badge.admin { background: rgba(92,79,255,0.1); color: var(--accent2); }
