  ...
  <div class="app-shell">
    ...
    <div class="shell-body">
      ...
      <aside class="sidebar">
        ...
        <div class="legend-item"><span class="leg-dot" style="background:#5c4fff"></span> Task</div>
        ...
        <div class="legend-item"><span class="leg-dot" style="background:#bb5cf7"></span> Epic</div>
...
const statuses = [
  { value: 'todo',        label: 'To Do',       color: '#9090b0' },
  { value: 'in_progress', label: 'In Progress',  color: '#5c4fff' },
  { value: 'in_review',   label: 'In Review',    color: '#ffd166' },
  { value: 'done',        label: 'Done',         color: '#00d97e' },
  { value: 'backlog',     label: 'Backlog',      color: '#55556a' },
]
...
function priorityBorder(priority) {
  const map = { critical: '#ff4f6a', high: '#ff8c42', medium: '#ffd166', low: '#5c4fff' }
...
.cal-cell.is-today { border-color:rgba(92,79,255,0.5); background:rgba(92,79,255,0.05); }
...
.cell-issue-chip.type-task  { background:rgba(92,79,255,0.12); color:var(--accent2); }
...
.cell-issue-chip.type-epic  { background:rgba(187,92,247,0.12); color:#bb5cf7; }
...
.status-pill-in_progress { background:rgba(92,79,255,0.12); color:var(--accent2); }
...
.type-task  { background:rgba(92,79,255,0.12); color:var(--accent2); }
.type-bug   { background:rgba(255,79,106,0.12); color:var(--red); }
.type-story { background:rgba(0,217,126,0.12); color:var(--green); }
.type-epic  { background:rgba(187,92,247,0.12); color:#bb5cf7; }
</style>
