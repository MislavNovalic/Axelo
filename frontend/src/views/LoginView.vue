    ...
    <div class="auth-left">
      ...
      <div class="auth-hero animate-fade-up">
        ...
        <div class="feature-pills">
          <div class="pill" style="--delay:0.5s"><span class="dot" style="background:#5c4fff"></span> Kanban Boards</div>
          ...
          <div class="pill" style="--delay:1.1s"><span class="dot" style="background:#bb5cf7"></span> Self-Hostable</div>
        </div>
      </div>
...
@keyframes logoPulse {
  ...
  50% { box-shadow: 0 0 32px var(--accent-glow), 0 0 8px rgba(92,79,255,0.4); }
}
...
.input-wrap.focused { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(92,79,255,0.18); }
.input-wrap.filled:not(.focused) { border-color: rgba(92,79,255,0.3); }
...
.btn-main { width: 100%; padding: 13px; background: var(--accent); color: #fff; border: none; border-radius: 10px; font-family: var(--font-display); font-size: 0.9rem; font-weight: 700; cursor: pointer; margin-top: 0.25rem; box-shadow: 0 4px 20px rgba(92,79,255,0.3); transition: transform 0.15s, box-shadow 0.2s, opacity 0.15s; display: flex; align-items: center; justify-content: center; min-height: 46px; }
.btn-main:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 8px 28px rgba(92,79,255,0.5); }
...
.sso-btn:hover { border-color: var(--accent); background: rgba(92,79,255,0.06); }
...
.hint-label { font-size: 0.65rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: var(--accent2); background: rgba(92,79,255,0.1); padding: 2px 7px; border-radius: 4px; flex-shrink: 0; }
