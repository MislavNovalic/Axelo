...
const statCards = computed(() => [
  { label: 'Total Projects', value: stats.value.total_projects ?? projects.value.length, sub: 'Active workspaces',     color: '#5c4fff', barPct: 100, up: false },
...
.status-in_progress { background: rgba(92,79,255,0.15); color: var(--accent2); }
...
.p4-ai { border-color: rgba(187,92,247,0.2); background: linear-gradient(135deg, rgba(187,92,247,0.05) 0%, rgba(92,79,255,0.05) 100%); }
.p4-ai:hover { border-color: rgba(187,92,247,0.4); box-shadow: 0 6px 24px rgba(187,92,247,0.15); }
.p4-ai .p4-icon { color: #bb5cf7; }
.p4-ai .p4-label { color: #bb5cf7; }
...
.p4-import { border-color: rgba(92,79,255,0.2); background: rgba(92,79,255,0.04); }
.p4-import:hover { border-color: rgba(92,79,255,0.35); box-shadow: 0 6px 24px rgba(92,79,255,0.12); }
@media (max-width: 640px) { .p4-cards { grid-template-columns: 1fr; } }
