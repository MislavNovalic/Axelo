...
.source-card.selected { border-color: var(--accent); background: rgba(92,79,255,0.07); }
...
.upload-card.dragover { border-color: var(--accent); background: rgba(92,79,255,0.05); }
...
.status-chip.in_progress { background: rgba(92,79,255,0.1); color: var(--accent2); }
...
.source-tag { font-size: 0.72rem; font-weight: 700; text-transform: uppercase; padding: 2px 7px; background: rgba(92,79,255,0.1); color: var(--accent2); border-radius: 4px; flex-shrink: 0; }
...
.job-status.running { background: rgba(92,79,255,0.1); color: var(--accent2); }
