      ...
      <main class="content">
        ...
        <div v-if="activeTab === 'burndown'" class="report-card anim-slide-up" style="--delay:0.1s">
          <div class="card-header">
            ...
            <div class="legend">
              <span class="legend-item"><span class="dot" style="background:#5c4fff"></span> Ideal</span>
          ...
          <svg v-else-if="burndown" class="chart-svg" :viewBox="`0 0 ${W} ${H}`" preserveAspectRatio="none">
            ...
            <!-- Ideal line -->
            <polyline :points="idealPoints" fill="none" stroke="#5c4fff" stroke-width="2" stroke-dasharray="6 3" opacity="0.7"/>
            <!-- Actual line -->
        ...
        <div v-if="activeTab === 'flow'" class="report-card anim-slide-up" style="--delay:0.1s">
          <div class="card-header">
            ...
            <div class="legend">
              <span class="legend-item"><span class="dot" style="background:#5c4fff"></span> Created</span>
          ...
          <svg v-else-if="flow" class="chart-svg" :viewBox="`0 0 ${W} ${H}`" preserveAspectRatio="none">
            <line v-for="i in 4" :key="i" :x1="PAD" :x2="W-PAD/2"
              ...
              stroke="rgba(255,255,255,0.05)" stroke-width="1"/>
            <polyline :points="flowCreatedPoints" fill="none" stroke="#5c4fff" stroke-width="2"/>
...
.tab-btn.active { background: rgba(92,79,255,0.15); border-color: rgba(92,79,255,0.4); color: var(--accent2); }
...
.metric-chip { background: rgba(92,79,255,0.12); color: var(--accent2); font-size: 0.78rem; font-weight: 600; padding: 4px 10px; border-radius: 8px; }
...
.committed-bar { background: rgba(92,79,255,0.3); }
...
.action-updated  { background: rgba(92,79,255,0.12); color: var(--accent2); }
