<template>
  ...
  <!-- ── GitHub Integration ── -->
  <div class="section anim-slide-up" style="--delay:0.3s">
...
import { projectsApi, githubApi, templatesApi } from '@/api'
...
.rl-state.merged { background: rgba(92,79,255,0.12); color: var(--accent2); }
...
.roadmap-link:hover { border-color: var(--accent); background: rgba(92,79,255,0.06); }
</style>
